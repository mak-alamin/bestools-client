        ...
        <>
            <form  onSubmit={handleSubmit(handleUpdateProduct)}>
                    ...
                    <div className='w-1/2'>
                        ...
                        <div className="form-control w-full max-w-xs mb-3">
                            <label className="label" htmlFor='product_desc'> <span className="label-text">Description: </span></label>
                                <textarea {...register("description")} defaultValue={product?.description} id="product_desc" className="textarea textarea-bordered" placeholder="Product descripton here..."></textarea>
                        </div>
                ...
                <div className="submit flex gap-x-5 items-center">
                    <input className="btn btn-accent max-w-xs mr-4" value="Update Product" type="submit" />

                    {submitLoader && <Loading></Loading>}

                    <BesToolsAlert info={alertInfo} setAlertInfo={setAlertInfo}></BesToolsAlert>
                </div>
