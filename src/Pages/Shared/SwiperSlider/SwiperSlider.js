        ...
        <SwiperSlide className={styles.slider1}>
          ...
          >
            <div className="container">
              ...
              <a
                href="#featured_tools"
                className="btn bg-black hover:bg-info max-w-max text-white text-lg border-0 mt-5"
              >
                Get Your Tool
              </a>
            </div>
        ...
        <SwiperSlide className={styles.slider2}>
          ...
          >
            <div className="container flex flex-col items-end">
              ...
              <a
                href="#featured_tools"
                className="btn bg-primary hover:bg-info max-w-max text-white text-lg border-0 mt-5"
              >
                Get Your Tool
              </a>
            </div>
